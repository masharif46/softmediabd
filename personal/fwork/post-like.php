...
function like_scripts() {
	wp_enqueue_script( 'jm_like_post', get_template_directory_uri().'/mas/js/like.js', array('jquery'), '1.0', 1 );
...
function getPostLikeLink( $post_id ) {
	...
	$output .= '<a data-toggle="tooltip" title="'.$likes.'" href="#" data-post_id="'.$post_id.'">';
...
function show_user_likes( $user ) { ?>        
    <table class="form-table">
        <tr>
			<th><label for="user_likes"><?php _e( 'You Like:','erika' ); ?></label></th>
			<td>
