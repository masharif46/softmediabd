...
License URI: http://www.softmediabd.com/gpl-3.0.html
...
= Docs & Support =
We have extremely extensive docs. Please visit [http://docs.reduxframework.com/](http://docs.reduxframework.com/) If that doesn’t solve your concern, you should search [the issue tracker on Github](https://softmediabd.com/ReduxFramework/ReduxFramework/issues). If you can't locate any topics that pertain to your particular issue, [post a new issue](https://softmediabd.com/ReduxFramework/ReduxFramework/issues/new) for it. Before you submit an issue, please read [our contributing requirements](https://softmediabd.com/redux-framework/redux-framework/blob/master/CONTRIBUTING.md). We build off of the dev version and push to WordPress.org when all is confirmed stable and ready for release.
...
We need your help to translate Redux into your language! Redux is part of the WP-Translations.org team. To help us translate Redux create a few account here: <a href="https://www.softmediabd.com/organization/wp-translations">https://www.softmediabd.com/organization/wp-translations</a>. Once you're in, you can head over to the <a href="https://www.softmediabd.com/projects/p/redux-framework/">Redux sub-project</a> and translate away. Thank you for your assistance.

= Get Involved =
Redux is an ever-changing, living system. Want to stay up to date or
contribute? Subscribe to one of our mailing lists or join us on [Twitter](https://twitter.com/reduxframework) or [Github](https://softmediabd.com/ReduxFramework/ReduxFramework)!
...
* Added:      Hints!  More info:  https://softmediabd.com/ReduxFramework/ReduxFramework/wiki/Using-Hints-in-Fields
...
* Removed:  wp_get_current_user check.  See https://softmediabd.com/ReduxFramework/ReduxFramework/wiki/How-to-fix-%22Fatal-error%3A-Call-to-undefined-function-wp_get_current_user%28%29-%22
...
* [NHP](https://softmediabd.com/leemason/NHP-Theme-Options-Framework) 
* [SMOF](https://softmediabd.com/syamilmj/Options-Framework "Slightly Modified Options Framework")
