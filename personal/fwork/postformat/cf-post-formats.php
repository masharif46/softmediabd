 ...
 * http://softmediabd.comp
 *
 * This is an add-on for WordPress
 * http://softmediabd.com
 *
 * **********************************************************************
...
function cfpf_add_meta_boxes($post_type) {
	if (post_type_supports($post_type, 'post-formats') && current_theme_supports('post-formats')) {
		// assets
		wp_enqueue_script('cf-post-formats', get_template_directory_uri().'/fwork/postformat/js/admin.js', array('jquery'), CFPF_VERSION);
		wp_enqueue_style('cf-post-formats', get_template_directory_uri().'/fwork/postformat/css/admin.css', array(), CFPF_VERSION, 'screen');
